    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-inline">
                <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#registrar">Registrar alquiler</button>
            </div>
                ...
                <#list alquileres as alquiler>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/borrar/alquiler?id=${alquiler.getId()}" class="btn btn-danger btn-xs">Borrar</a>
